"""
Django settings for Ghumante project.
...
WSGI_APPLICATION = 'Ghumante.wsgi.application'
...
DATABASES = {
        'default': {
            ...
            'NAME': 'ghamantelite',  # This is where you put the name of the db file.
